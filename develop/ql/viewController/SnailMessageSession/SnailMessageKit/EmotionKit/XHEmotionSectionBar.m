...
{
    [Global sharedGlobal].isFirstInstall = NO;
...
//            scrollWidth -= kSnailSendButtonWidth;
    ...
    if (self.isShowEmotionSendButton)
    {
        ...
        [sendButton setTitleColor:[UIColor colorWithRed:217.f/255.f green:235.f/255.f blue:255.f/255.f alpha:1] forState:UIControlStateNormal];
        sendButton.backgroundColor = [UIColor colorWithRed:0.f/255.f green:122.f/255.f blue:255.f/255.f alpha:255.f/255.f];
