...
- (void)loadStoreMainView
{
    ...
    emotionTable.separatorColor = [[ThemeManager shareInstance]getColorWithName:@"COLOR_AUXILIARY"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (cellSection) {
        ...
        case 1:
        {
            ...
            if (listCell == nil) {
                listCell = [[SnailEmotionCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIndetify];
            }
