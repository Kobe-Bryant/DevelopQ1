...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        CGRect detailRect = CGRectMake(100, 45, 160, 20);
...
{
    NSURL * iconUrl = [NSURL URLWithString:emotionData.iconUrl];
    [self.thumbIcon setImageWithURL:iconUrl placeholderImage:IMGREADFILE(@"default_600.png")];
