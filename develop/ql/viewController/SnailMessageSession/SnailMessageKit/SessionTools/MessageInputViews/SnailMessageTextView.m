...
@implementation SnailMessageTextView
...
- (void)setPlaceHolder:(NSString *)placeHolder {
    ...
    NSUInteger maxChars = [SnailMessageTextView maxCharactersPerLine];
...
- (NSUInteger)numberOfLinesOfText {
    return [SnailMessageTextView numberOfLinesForMessage:self.text];
}
...
+ (NSUInteger)numberOfLinesForMessage:(NSString *)text {
    return (text.length / [SnailMessageTextView maxCharactersPerLine]) + 1;
}
