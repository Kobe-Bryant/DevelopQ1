...
//                                [NSNumber numberWithInt:4],@"type",nil];
...
//            tMod.where = [NSString stringWithFormat:@"user_id = %d",[[Global sharedGlobal].user_id intValue]];
...
//            pMod.where = [NSString stringWithFormat:@"user_id = %d",[[Global sharedGlobal].user_id intValue]];
...
////    UIImage *image = [[UIImage alloc ]initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"ico_common_return" ofType:@"png"]];
...
//    textBgView.backgroundColor = [[ThemeManager shareInstance] getColorWithName:@"COLOR_LIGHTWEIGHT"];
...
//    NSMutableDictionary *secdic = [NSMutableDictionary dictionaryWithObjectsAndKeys:
//                                @"非常感谢您的留言，稍后小秘书会给您答复。",@"content",
//                                [NSNumber numberWithLongLong:[[NSDate date] timeIntervalSince1970]],@"created",
//                                @"kf.jpg",@"portrait",
//                                [NSNumber numberWithInt:4],@"type",nil];
//    [self.listArray addObject:secdic];
...
//    if ([dic objectForKey:@"sendMessageSelf"] != nil) {
//        cell.type = BubbleTypeSomeoneElse;
//    }else{
//        cell.type = BubbleTypeMine;
//    }
...
//        [Common checkProgressHUD:@"发送失败" andImage:nil showInView:self.view];
