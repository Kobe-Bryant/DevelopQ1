//
//  TempCircleDetailOtherViewController.m
//  ql
//
...
@interface TempCircleDetailOtherViewController ()<ModifyInfoDelegate>

@property(nonatomic,retain) UILabel* circleNameLab;

@end

@implementation TempCircleDetailOtherViewController
...
-(UITableViewCell*) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    switch (indexPath.section) {
        ...
        case 3:
        {
            ...
            [dissolve addTarget:self action:@selector(quitTempCircle) forControlEvents:UIControlEventTouchUpInside];
