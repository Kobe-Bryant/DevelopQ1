...
- (id) initWithFrame:(CGRect)theFrame oneDMode:(BOOL)isOneDModeEnabled {
    ...
    if(self){
        ...
        UIImage *backgroundImage = [[UIImage alloc]initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"yunpai_scan_bg" ofType:@"png"]];
        ...
        //关闭按钮
        UIImage *cancelImage = [[UIImage alloc]initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"yunpai_close_btn" ofType:@"png"]];
        ...
        //历史记录
        UIImage *historyImage = [[UIImage alloc]initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"yunpai_history_btn" ofType:@"png"]];
