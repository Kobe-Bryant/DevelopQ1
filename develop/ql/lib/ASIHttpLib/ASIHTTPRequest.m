...
static NSTimeInterval defaultTimeOutSeconds = kHttpTimeOutTime;
...
- (id)initWithURL:(NSURL *)newURL
{
	...
	[self setPersistentConnectionTimeoutSeconds:kHttpTimeOutTime];
