...
//        }else{
        NSLog(@"image_path %@",[obj objectForKey:@"image_path"]);
        [tempImage setImageWithURL:[NSURL URLWithString:[obj objectForKey:@"image_path"]] placeholderImage:IMGREADFILE(@"default_600.png")];
        tempImage.layer.masksToBounds = YES;
        tempImage.layer.cornerRadius = 5;
        /*
