...
{
    NSString *reqstr = [Common TransformJson:dic withLinkStr:[ACCESS_SERVER_LINK stringByAppendingString:requestUrl]];
...
+(NSDictionary *) upLoadPicWithPara:(NSMutableDictionary *)param
    ...
    NSString *reqstr = [Common TransformJson:param withLinkStr:[ACCESS_SERVER_LINK stringByAppendingString:requestUrl]];
