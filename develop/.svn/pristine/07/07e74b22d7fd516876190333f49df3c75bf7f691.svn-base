...
- (id)initWithFrame:(CGRect)frame
    ...
    if (self) {
        ...
        remiderImg.frame = CGRectMake((CGRectGetWidth(frame) - 120.f)/ 2 , (CGRectGetHeight(frame) - 120.f)/ 2, 120.f, 120.f);
        ...
        signTitle.frame = CGRectMake(0.f , (CGRectGetHeight(frame) + 100)/ 2, KUIScreenWidth, 30.f);
