...
- (void)reloadMainView
{
    ...
    self.detailText.frame = (CGRect){.origin = self.detailText.frame.origin,.size = CGSizeMake(textSize.width + 15, textSize.height)};
...
- (void)loadDownloadButton
{
    ...
    [downloadButton setTitleColor:COLOR_CONTROL forState:UIControlStateNormal];
