...
{
    long long emotionID = [[dic objectForKey:@"emoticon_id"]longLongValue];
    emoticon_list_model * geter = [[emoticon_list_model alloc]init];
    geter.where = [NSString stringWithFormat:@"emoticon_id = %lld",emotionID];
...
{
    emoticon_list_model * geter = [[emoticon_list_model alloc]init];
    geter.where = [NSString stringWithFormat:@"emotion_id = %lld",emotionID];
